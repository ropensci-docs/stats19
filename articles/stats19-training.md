...
package (Lovelace et al. 2019). However, the content should be of use
for anyone working with road crash data that has (at a minimum):
...
[‘tidyverse’](https://www.tidyverse.org/) meta-package, which is an
...
Geocomputation with R (Lovelace, Nowosad, and Muenchow 2019) for further
