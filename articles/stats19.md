...
#> Data saved at /tmp/RtmpaRumNa/dft-road-casualty-statistics-collision-2022.csv
#> NULL
```
...
#> Reading in:
#> /tmp/RtmpaRumNa/dft-road-casualty-statistics-collision-2022.csv
```
...
#>    police_force local_authority_highwa…¹ junction_detail_hist…² junction_control
#>    <chr>        <chr>                    <chr>                  <chr>           
#>  1 Durham       E06000005                T or staggered juncti… Give way or unc…
#>  2 Durham       E06000005                T or staggered juncti… Give way or unc…
#>  3 Cheshire     E06000007                Other junction         Give way or unc…
#>  4 Cheshire     E06000007                Not at junction or wi… Data missing or…
#>  5 Cheshire     E06000007                Roundabout             Give way or unc…
#>  6 Lancashire   E06000009                T or staggered juncti… Give way or unc…
#>  7 Humberside   E06000010                T or staggered juncti… Give way or unc…
#>  8 Humberside   E06000010                Not at junction or wi… Data missing or…
#>  9 Humberside   E06000010                T or staggered juncti… Auto traffic si…
#> 10 Humberside   E06000011                Roundabout             Give way or unc…
#> # ℹ 105,994 more rows
#> # ℹ abbreviated names: ¹​local_authority_highway_current,
#> #   ²​junction_detail_historic
```
...
#> Data saved at /tmp/RtmpaRumNa/dft-road-casualty-statistics-vehicle-2022.csv
#> NULL
...
#> casualty_adjusted_serious, casualty_adjusted_slight, casualty_class,
#> casualty_distance_banding, casualty_imd_decile, casualty_injury_based,
...
#> carriageway_hazards, carriageway_hazards_historic, collision_adjusted_serious,
#> collision_adjusted_slight, collision_injury_based, collision_severity, date,
...
#> junction_detail_historic, latitude, light_conditions, local_authority_district,
...
#> number_of_casualties, number_of_vehicles, pedestrian_crossing,
#> pedestrian_crossing_human_control_historic,
#> pedestrian_crossing_physical_facilities_historic, police_force,
#> road_surface_conditions, road_type, second_road_class, second_road_number,
#> special_conditions_at_site, speed_limit, time, trunk_road_flag,
#> urban_or_rural_area, weather_conditions, accident_index, accident_ref_no,
#> accident_year, effective_date_of_change, previously_published_value,
#> replacement_value, variable
...
#> Data saved at /tmp/RtmpaRumNa/dft-road-casualty-statistics-casualty-2022.csv
#> NULL
...
| collision_year       | integer   |        1 | 2022             | 2022              |
| collision_ref_no     | character |   106004 | 111177692        | 010352073         |
| location_easting_os  | integer   |    85481 | 429274           | 533653            |
| location_northing_o  | integer   |    85711 | 514446           | 180088            |
| longitude            | integer   |        1 | NA               | NA                |
| latitude             | integer   |        1 | NA               | NA                |
...
| local_authority_dis  | character |        1 | Code deprecated  | Code deprecated   |
...
| junction_detail_his  | character |       10 | T or staggered j | Not at junction   |
...
| lsoa_of_accident_lo  | character |    26849 | E01033484        | -1                |
| enhanced_severity_c  | numeric   |        6 | 3                | -1                |
...
| collision_year       | integer   |        1 | 2022             | 2022              |
| collision_ref_no     | character |   106004 | 010389933        | 371220504         |
| vehicle_reference    | character |       24 | 2                | 1                 |
| vehicle_type         | character |       22 | Car              | Car               |
| towing_and_articula  | character |        8 | No tow/articulat | No tow/articulat  |
| vehicle_manoeuvre_h  | character |       20 | unknown (self re | Going ahead othe  |
...
| vehicle_location_re  | character |       12 | unknown (self re | On main c’way -   |
...
| vehicle_left_hand_d  | character |        3 | Unknown          | No                |
| journey_purpose_of\_ | character |        6 | Not known        | Not known         |
| journey_purpose_of\_ | character |        4 | Not known or not | Not known or not  |
| sex_of_driver        | character |        3 | Not known        | Male              |
| age_of_driver        | integer   |       99 | NA               | 30                |
| age_band_of_driver   | character |       12 | Data missing or  | 26 - 35           |
| engine_capacity_cc   | integer   |     1015 | 5998             | 1598              |
| propulsion_code      | character |       10 | Petrol           | Petrol            |
| age_of_vehicle       | integer   |       86 | 18               | -1                |
| generic_make_model   | character |      701 | BENTLEY CONTINEN | Data missing or   |
| driver_imd_decile    | character |       11 | Data missing or  | Data missing or   |
| lsoa_of_driver       | character |    32838 | -1               | -1                |
| escooter_flag        | character |        2 | Vehicle was not  | Vehicle was not   |
| driver_distance_ban  | character |        1 | -1               | -1                |
...
| collision_year      | integer   |        1 | 2022             | 2022              |
| collision_ref_no    | character |   106004 | 170L10602        | 010356595         |
...
| age_of_casualty     | integer   |      103 | 50               | 18                |
...
| lsoa_of_casualty    | character |    31105 | E01012181        | -1                |
| enhanced_casualty_s | character |        6 | Data missing or  | Data missing or   |
...
| casualty_distance_b | character |        1 | Data missing or  | Data missing or   |
...
casualties_2022 = read_casualties(year = 2022)
#> Warning: The following named parsers don't match the column names:
#> casualty_adjusted_serious, casualty_adjusted_slight, carriageway_hazards,
#> carriageway_hazards_historic, collision_adjusted_serious,
#> collision_adjusted_slight, collision_injury_based, collision_severity, date,
#> day_of_week, did_police_officer_attend_scene_of_accident,
#> did_police_officer_attend_scene_of_collision, enhanced_collision_severity,
#> first_road_class, first_road_number, junction_control, junction_detail,
...
#> urban_or_rural_area, weather_conditions, accident_index, accident_ref_no,
#> accident_year, effective_date_of_change, previously_published_value,
#> replacement_value, variable, age_band_of_driver, age_of_driver, age_of_vehicle,
#> driver_distance_banding, driver_imd_decile, engine_capacity_cc, escooter_flag,
#> first_point_of_impact, generic_make_model, hit_object_in_carriageway,
#> hit_object_off_carriageway, journey_purpose_of_driver,
#> journey_purpose_of_driver_historic, junction_location, lsoa_of_driver,
...
#> # A tibble: 193,545 × 4
#>    collision_ref_no skidding_and_overturning hit_object_in_carriageway   
#>    <chr>            <chr>                    <chr>                       
#>  1 010389933        unknown (self reported)  unknown (self reported)     
#>  2 201298706        None                     None                        
#>  3 010395084        None                     None                        
#>  4 311177520        None                     None                        
#>  5 421182218        Overturned               None                        
#>  6 221153345        None                     None                        
#>  7 351217120        None                     None                        
#>  8 411205390        None                     Central island of roundabout
#>  9 010386619        None                     None                        
#> 10 010379766        unknown (self reported)  unknown (self reported)     
#> # ℹ 193,535 more rows
#> # ℹ 1 more variable: vehicle_leaving_carriageway <chr>
```
...
#>  [4] "vehicle_reference"                        
#>  [5] "vehicle_type"                             
#>  [6] "towing_and_articulation"                  
#>  [7] "vehicle_manoeuvre_historic"               
#>  [8] "vehicle_manoeuvre"                        
#>  [9] "vehicle_direction_from"                   
#> [10] "vehicle_direction_to"                     
#> [11] "vehicle_location_restricted_lane_historic"
#> [12] "vehicle_location_restricted_lane"         
#> [13] "junction_location"                        
#> [14] "skidding_and_overturning"                 
#> [15] "hit_object_in_carriageway"                
#> [16] "vehicle_leaving_carriageway"              
#> [17] "hit_object_off_carriageway"               
#> [18] "first_point_of_impact"                    
#> [19] "vehicle_left_hand_drive"                  
#> [20] "journey_purpose_of_driver_historic"       
#> [21] "journey_purpose_of_driver"                
#> [22] "sex_of_driver"                            
#> [23] "age_of_driver"                            
#> [24] "age_band_of_driver"                       
#> [25] "engine_capacity_cc"                       
#> [26] "propulsion_code"                          
#> [27] "age_of_vehicle"                           
#> [28] "generic_make_model"                       
#> [29] "driver_imd_decile"                        
#> [30] "lsoa_of_driver"                           
#> [31] "escooter_flag"                            
...
summary(cj)
#>  collision_index    collision_year collision_ref_no     longitude   
#>  Length:4400        Min.   :2022   Length:4400        Min.   : NA   
#>  Class :character   1st Qu.:2022   Class :character   1st Qu.: NA   
#>  Mode  :character   Median :2022   Mode  :character   Median : NA   
#>                     Mean   :2022                      Mean   :NaN   
#>                     3rd Qu.:2022                      3rd Qu.: NA   
#>                     Max.   :2022                      Max.   : NA   
#>                                                       NA's   :4400  
#>     latitude    police_force       collision_severity number_of_vehicles
#>  Min.   : NA    Length:4400        Length:4400        Length:4400       
...
#>  Length:4400        Length:4400               Min.   :-1.000             
...
#>                         Max.   :1.0000                     
#>                                                            
#>  collision_adjusted_severity_slight    datetime                  
#>  Min.   :0.0000                     Min.   :2022-01-01 01:20:00  
#>  1st Qu.:0.0000                     1st Qu.:2022-04-03 04:20:30  
#>  Median :1.0000                     Median :2022-07-05 11:36:00  
#>  Mean   :0.7111                     Mean   :2022-07-05 14:07:43  
#>  3rd Qu.:1.0000                     3rd Qu.:2022-10-08 06:07:30  
#>  Max.   :1.0000                     Max.   :2022-12-31 20:49:00  
#>                                                                  
#>           geometry        Total          walking          cycling     
#>  POINT        :4400   Min.   :1.000   Min.   :0.0000   Min.   :0.000  
#>  epsg:27700   :   0   1st Qu.:1.000   1st Qu.:0.0000   1st Qu.:0.000  
#>  +proj=tmer...:   0   Median :1.000   Median :0.0000   Median :0.000  
#>                       Mean   :1.301   Mean   :0.2511   Mean   :0.095  
#>                       3rd Qu.:1.000   3rd Qu.:0.0000   3rd Qu.:0.000  
#>                       Max.   :8.000   Max.   :4.0000   Max.   :2.000  
#>                                                                       
#>    passenger     
#>  Min.   :0.0000  
#>  1st Qu.:0.0000  
...
peaks, in-line with previous research (Lovelace, Roberts, and Kellar
2016). A disproportionate number of car crashes appear to happen in the
afternoon.
...
- Assessment of crash rates normalised by estimated exposure rates
  ...
  casualties across West Yorkshire (Lovelace, Roberts, and Kellar 2016).
  This raises the questions: are similar spatial differences found in
  other regions? What are the factors leading to relatively high and low
  rates of different types of crash?
